...
class FaceSwapApp:
    ...
    def email_result(self):
            ...
            try:
                ...
                # Email details (örnek, kendi bilgilerini girmen lazım)
                sender_email = "projeuneasso@gmail.com"
                sender_password = "qriv crzm bocj bevx"  # Gmail app password
                ...
                body = "Hi,\n\nHere is your face-swapped photo.\n\nBest regards,\nProfessional Face Swap App"
                ...
                messagebox.showinfo("Success", f"Photo emailed to {recipient_email}.")
