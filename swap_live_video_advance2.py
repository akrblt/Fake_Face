...
class FaceSwapApp:
    ...
    def setup_ui(self):
        ...
        self.make_button(left_buttons, "Webcam Source", lambda: self.capture_from_webcam(is_source=True)).pack(side=LEFT, padx=5)
        self.make_button(left_buttons, "Webcam Target", lambda: self.capture_from_webcam(is_source=False)).pack(side=LEFT, padx=5)
